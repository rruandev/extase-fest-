...
export const INGRESSOS: Record<TipoIngresso, CategoriaIngresso> = {
  pista: {
    ...
    lotes: [
      { numero: 1, preco: 40, quantidade: 100 },
      { numero: 2, preco: 60, quantidade: 100 },
      { numero: 3, preco: 80, quantidade: 60 },
    ],
    precoPorta: 100,
    limiteTotal: null,
    beneficios: [],
  ...
  vip: {
    ...
    lotes: [
      { numero: 1, preco: 120, quantidade: 40 },
      { numero: 2, preco: 150, quantidade: 50 },
      { numero: 3, preco: 180, quantidade: 30 },
    ],
    precoPorta: 200,
    limiteTotal: 120,
    beneficios: [
